...
if { [catch {
  file copy -force F:/miniRV-HITSZ/miniRV-HITSZ.runs/IROM_synth_1/IROM.dcp F:/miniRV-HITSZ/miniRV-HITSZ.srcs/sources_1/ip/IROM/IROM.dcp
} _RESULT ] } { 
...
if { [catch {
  write_verilog -force -mode synth_stub F:/miniRV-HITSZ/miniRV-HITSZ.srcs/sources_1/ip/IROM/IROM_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode synth_stub F:/miniRV-HITSZ/miniRV-HITSZ.srcs/sources_1/ip/IROM/IROM_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_verilog -force -mode funcsim F:/miniRV-HITSZ/miniRV-HITSZ.srcs/sources_1/ip/IROM/IROM_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode funcsim F:/miniRV-HITSZ/miniRV-HITSZ.srcs/sources_1/ip/IROM/IROM_sim_netlist.vhdl
} _RESULT ] } { 
...
if { [catch {
  file rename -force F:/miniRV-HITSZ/miniRV-HITSZ.runs/IROM_synth_1/IROM_stub.v F:/miniRV-HITSZ/miniRV-HITSZ.srcs/sources_1/ip/IROM/IROM_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force F:/miniRV-HITSZ/miniRV-HITSZ.runs/IROM_synth_1/IROM_stub.vhdl F:/miniRV-HITSZ/miniRV-HITSZ.srcs/sources_1/ip/IROM/IROM_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force F:/miniRV-HITSZ/miniRV-HITSZ.runs/IROM_synth_1/IROM_sim_netlist.v F:/miniRV-HITSZ/miniRV-HITSZ.srcs/sources_1/ip/IROM/IROM_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  file rename -force F:/miniRV-HITSZ/miniRV-HITSZ.runs/IROM_synth_1/IROM_sim_netlist.vhdl F:/miniRV-HITSZ/miniRV-HITSZ.srcs/sources_1/ip/IROM/IROM_sim_netlist.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the VHDL functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}
...
if {[file isdir F:/miniRV-HITSZ/miniRV-HITSZ.ip_user_files/ip/IROM]} {
    ...
    file copy -force F:/miniRV-HITSZ/miniRV-HITSZ.srcs/sources_1/ip/IROM/IROM_stub.v F:/miniRV-HITSZ/miniRV-HITSZ.ip_user_files/ip/IROM
  }
}

if {[file isdir F:/miniRV-HITSZ/miniRV-HITSZ.ip_user_files/ip/IROM]} {
  catch { 
    file copy -force F:/miniRV-HITSZ/miniRV-HITSZ.srcs/sources_1/ip/IROM/IROM_stub.vhdl F:/miniRV-HITSZ/miniRV-HITSZ.ip_user_files/ip/IROM
  }
}
